                            ...
                            <div class="card">
                                ...
                                <div class="card-body px-2 mx-2">
                                    ...
                                    <div class="row justify-content-center align-items-center mx-2">
                                        <div class="col-md-6">
                                            <div class="form-floating mb-3" style="background: none;">
                                                <asp:TextBox ID="txtEmail" TextMode="Email" CssClass="form-control form-control-sm" placeholder="Name@example.com" runat="server"></asp:TextBox>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-floating mb-3" style="background: none;">
                                                <asp:TextBox ID="txtPhoneNo" TextMode="Phone" CssClass="form-control form-control-sm" placeholder="Phone Number" runat="server"></asp:TextBox>
                                    ...
                                    <div class="row justify-content-center align-items-center mx-2">
                                        <div class="col-md-4">
                                            <div class="form-floating mb-3" style="background: none;">
                                                <asp:DropDownList ID="ddlCountry" CssClass="form-control form-control-sm" placeholder="Country" runat="server"></asp:DropDownList>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-floating mb-3" style="background: none;">
                                               <asp:DropDownList ID="ddlState" runat="server" CssClass="form-control form-control-sm" placeholder="State"></asp:DropDownList>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-floating mb-3" style="background: none;">
                                               <asp:DropDownList ID="ddlCity"  runat="server" CssClass="form-control form-control-sm" placeholder="City"></asp:DropDownList>
                                    ...
                                    <div class="row justify-content-center align-items-center mx-2">
                                        <div class="col-md-6">
                                            <div class="form-floating mb-3" style="background: none;">
                                                <asp:TextBox ID="txtPassword" TextMode="Password" runat="server" CssClass="form-control form-control-sm"></asp:TextBox>
                                                ...
                                                <asp:RegularExpressionValidator ID="regPassword" runat="server" ControlToValidate="txtPassword" ValidationExpression="^(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d]{8,}$" ErrorMessage="Password should contain eight characters, at least one letter and one number"></asp:RegularExpressionValidator>
                                              </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-floating mb-3" style="background: none;">
                                      ...
                                      <div class="col-md-12">
                                        <div class="row d-flex">
                                            ...
                                            <div class="col-md-6">
                                                <span class="text-white" style="font-size: 14px;">Already an User ? Please Click on<a class="btnClick" href="Login.aspx" type="button">&nbsp;Login</a></span>
                                            </div>
                                        </div>
                                      </div>
                                </div>
